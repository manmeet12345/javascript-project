...
var forward = document.getElementById("service-next");
var backward = document.getElementById("service-previous");
currentService = 0;
...
forward.onclick = function(){
  ...
  titleArea.innerHTML = ourServices[currentService].title;
  textArea.innerHTML = ourServices[currentService].text;
